...
2.  **Launch NeuroPixelAI:** Run:
    ...
    ```
A standard calcium imaging data processing workflow consists of five stages: **motion correction**, **image denoising**, **cell segmentation**, **signal extraction**, and **spike inference**. For a basic usage example, refer to [Supplementary Viedo 3](https://www.researchsquare.com/article/rs-7024540/v1).
