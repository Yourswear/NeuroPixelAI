...
parser.add_argument('--GPU', type=str, default='0', help="the index of GPU used for computation (e.g., '0', '0,1', '0,1,2')")

parser.add_argument('--denoise_model', type=str, default='srdtrans_1,3,10,30Hz', help='A folder containing models to be tested')
parser.add_argument('--datasets_folder', type=str, default='130um_Volumn_test', help="A folder containing all *.tif files for training")
